...
{
    public abstract class nercoreangularWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static nercoreangularWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(nercoreangularWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<nercoreangularDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<nercoreangularDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<nercoreangularDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<nercoreangularDbContext, Task<T>> func)
        {
            T result;
